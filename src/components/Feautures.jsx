...
const Features = () => {
  ...
  return (
    <div className="features">
      ...
      <button className="close-btn" onClick={toggleSideNav}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
