    ...
    <div className="outer-banner">
      <div className="banner">
        ...
        <div className="main-content">
          ...
          <div className="sponge-box-image1">
            <img src={image1} alt="sponge 1" />
          </div>
          <div className="sponge-box-image3">
            <img src={image3} alt="sponge 3" />
          </div>
          <div className="sponge-box-image4">
            <img src={image4} alt="sponge 4" />
          </div>
          <div className="sponge-box-image5">
            <img src={image5} alt="sponge 5" />
          </div>
        </div>
      </div>
      <Footer />
